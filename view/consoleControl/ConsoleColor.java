...
public class ConsoleColor {
    ...
    public ConsoleColor(String fontColor,String backGroundColor){
        this.fontColor = fontColor;
        this.BackGroundColor = backGroundColor;
    }
    public ConsoleColor(){
    }
    public ConsoleColor(String fontColor){
        this.fontColor = fontColor;
    }
    private String fontColor = FONT_WHITE;
    private String BackGroundColor = BACKGROUND_BLACK;
